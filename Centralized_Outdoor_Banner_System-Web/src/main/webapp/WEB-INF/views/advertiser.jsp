...
$.ajax({
                            	type: 'POST',
                            	url: '/controller/findAdsForAdvertiser',
                            	success: function(data){
                            		// $("#test").load("${pageContext.request.contextPath}/views/Results.jsp"); 
...
$.ajax({
	   ...
	   type: 'POST',
	   url: '/controller/AdssearchBylocation',
	   success:function(data){
		   $("#test").html(data);
	   }
})		
    ...
    <div class="container">
        <div class="media">
            <div class="media-body">
                <div class="col-md-13">
				<center>
                    <h2 class="title">OUR<span>Advertiser</span></h2>
					</center>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
				...
				<button class="btn btn-warning btn-block" onclick="javascript:history()">Booking History</button>
				<button class="btn btn-warning btn-block" onclick="javascript:searchByLocation()">Search Available Banner Location</button>
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        <div class="testimonial item">
                                                            ...
                                                            <div class="author">
                                                                ...
                                                                <div class="testimonial-author-info">
                                                                    <a href="#">Akash Banginwar</a> Project COBS
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
