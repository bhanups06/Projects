    ...
    <div class="container">
        <div class="media">
            <div class="media-body">
                <div class="col-md-13">
				<center>
                    <h2 class="title">Publisher<span>Dashboard</span></h2>
					</center>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
				...
				<button class="btn btn-warning btn-block" onclick="javascript:showad()">View Advertisements</button>
				<button class="btn btn-warning btn-block" onclick="javascript:postad()">Post New Ad</button>
